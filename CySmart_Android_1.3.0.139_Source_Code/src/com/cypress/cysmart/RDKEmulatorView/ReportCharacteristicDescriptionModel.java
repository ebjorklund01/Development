...
/**
 * Model class for storing the characteristic details
 */
class ReportCharacteristicDescriptionModel {
    ...
    public ReportCharacteristicDescriptionModel(BluetoothGattCharacteristic
                                                        bluetoothGattCharacteristic, int instanceID) {
        this.mGattCharacteristic = bluetoothGattCharacteristic;
        this.mCharacteristicReportReference = "";
