...
public class TemperatureVariable extends Variable<Temperature, Temperature.Unit> {
    ...
    public TemperatureVariable(Resources resources, PropertyChangeListener listener) {
        super(Id.ENV_TEMPERATURE, resources.getString(R.string.var_env_temperature), false, new Temperature(), listener);
    }
}
