...
public class Pressure extends ValueWithUnit<Pressure, Pressure.Unit> {

    private static final Unit DEFAULT_UNIT = Unit.PASCAL;
    ...
    public static class Unit extends ValueWithUnit.Unit {
        ...
        private static final Unit[] ALL_UNITS = {PASCAL};
